...
var NameProvider = ["Full Stack","Front-end","Back-end","Implementación de tecnologías web",
"Desarrollo con frameworks de Front-end","Administración de servidores","Desarrollo con frameworks de Back-end"];

var matrix = [
	[0,4,4,1,1,1,1], // Full Stack
	[4,0,0,2,2,0,0], // Front-end
	[4,0,0,0,0,2,2], // Back-end
	[1,2,0,0,0,0,0], // Implementación de tecnologías web
	[1,2,0,0,0,0,0], // Desarrollo con frameworks de Front-end
	[1,0,2,0,0,0,0], // Administración de servidores
	[1,0,2,0,0,0,0], // Desarrollo con frameworks de Back-end
	];
...
// var matrix = [
// 	[0,1,1,1,1,1,1,1], /*Apple 19.1584*/
// 	[1,0,1,1,1,1,1,1], /*HTC 5.3154*/
// 	[1,1,0,1,1,1,1,1], /*Huawei 2.3811*/
// 	[1,1,1,0,1,1,1,1], /*LG 4.8173*/
// 	[1,1,1,1,0,1,1,1], /*Nokia 15.8915*/
// 	[1,1,1,1,1,0,1,1], /*Samsung 38.0399*/
// 	[1,1,1,1,1,1,0,1], /*Sony 4.4297*/
// 	[1,1,1,1,1,1,1,0] /*Other 9.9667*/
// 	];


/*Sums up to exactly 100*/

var colors = ["#22D193","#69B40F","#EC1D25","#C8125C","#008FC8","#10218B","#134B24"];
// var colors = ["#C3C3C3","#69B40F","#EC1D25","#C8125C","#008FC8","#10218B","#134B24","#737373"];
...
var margin = {top: 150, right: 150, bottom: 150, left: 150},
    width = 850 - margin.left - margin.right, //Anchura
    height = 800 - margin.top - margin.bottom, //Altura
